      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Rider Settings</h1>
          </div>
          <p className="text-gray-600">Manage your rider account email and password</p>
        </div>
        ...
        <Card className="mt-6 border-green-200 bg-green-50">
          <CardContent className="pt-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-green-900">Security Notice</h3>
                <ul className="text-sm text-green-800 mt-2 space-y-1 list-disc list-inside">
                  ...
                  <li>Keep your credentials secure to protect your delivery account</li>
                </ul>
              </div>
            </div>
          </CardContent>
